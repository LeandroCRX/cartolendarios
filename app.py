...
# --- PROTEÇÃO CONTRA DADOS VAZIOS (A Mensagem Divertida) ---
# Se não houver dados filtrados OU a coluna Rodada estiver vazia
if df_c_comp.empty or 'Rodada' not in df_c_comp.columns or df_c_comp['Rodada'].isnull().all():
    ...
    st.stop() # Para o código aqui e não dá erro
# -----------------------------------------------------------
...
with tab2:
    ...
    # Tenta pegar o time para passar para a aba 3
    try:
